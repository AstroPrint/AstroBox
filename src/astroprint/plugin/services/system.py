...
class SystemService(PluginService):
	...
	def printerConnectionDriver(self, data, sendResponse):
		sendResponse(self._services["settings"].printerConnectionDriver())
		return

	def cameraSettings(self, data, sendResponse):
		sendResponse(self._services["settings"].cameraSettings())
		return

	def networkName(self, data, sendResponse):
		sendResponse(self._services["settings"].networkName())
		return

	def wifiNetworks(self, data, sendResponse):
		sendResponse(self._services["settings"].wifiNetworks())
		return

	def setWifiNetwork(self, data, sendResponse):
		sendResponse(self._services["settings"].setWifiNetwork())
		return

	def deleteStoredWiFiNetwork(self, data, sendResponse):
		sendResponse(self._services["settings"].deleteStoredWiFiNetwork())
		return
	...
	def getAdvancedSoftwareSettings(self, data, sendResponse):
		sendResponse(self._services["settings"].getAdvancedSoftwareSettings())
		return

	def changeApiKeySettings(self, data, sendResponse):
		sendResponse(self._services["settings"].changeApiKeySettings())
		return

	def resetFactorySettings(self, data, sendResponse):
		sendResponse(self._services["settings"].resetFactorySettings())
		return

	def checkSoftwareVersion(self, data, sendResponse):
		sendResponse(self._services["settings"].checkSoftwareVersion())
		return

	def updateSoftwareVersion(self, data, sendResponse):
		sendResponse(self._services["settings"].updateSoftwareVersion())
		return

	def sendLogs(self, data, sendResponse):
		sendResponse(self._services["settings"].sendLogs())
		return

	def changeSerialLogs(self, data, sendResponse):
		sendResponse(self._services["settings"].changeSerialLogs())
		return

	def clearLogs(self, data, sendResponse):
		sendResponse(self._services["settings"].clearLogs())
		return

	def getSysmteInfo(self, data, sendResponse):
		sendResponse(self._services["settings"].getSysmteInfo())
		return
