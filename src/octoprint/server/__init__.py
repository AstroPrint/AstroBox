...
class Server():
	...
	def run(self):
		...
		self._tornado_app = Application(self._router.urls + [
			...
			(r"/downloads/logs/([^/]*)", LargeResponseHandler, {"path": s.getBaseFolder("logs"), "as_attachment": True, "access_validation": access_validation_factory(user_or_logout_validator)}),
